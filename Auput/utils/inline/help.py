...
def first_page(_):
	...
	first_page_menu = InlineKeyboardMarkup(
		[
			...
			[InlineKeyboardButton(text=_["H_B_7"], callback_data="help_callback hb7"), InlineKeyboardButton(text=_["H_B_10"], callback_data="help_callback hb10")],
			controll_button,
		]
	)
...
def second_page(_):
	...
	second_page_menu = InlineKeyboardMarkup(
		[
			[InlineKeyboardButton(text=_["H_B_8"], callback_data="help_callback hb8"), InlineKeyboardButton(text=_["H_B_11"], callback_data="help_callback hb11"),InlineKeyboardButton(text=_["H_B_12"], callback_data="help_callback hb12")],
