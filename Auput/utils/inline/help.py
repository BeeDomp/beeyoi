...
def first_page(_):
	...
	first_page_menu = InlineKeyboardMarkup(
		[
			...
			[InlineKeyboardButton(text=_["H_B_7"], callback_data="help_callback hb7"), InlineKeyboardButton(text=_["H_B_8"], callback_data="help_callback hb8"),InlineKeyboardButton(text=_["H_B_17"], callback_data="help_callback hb17")],
			controll_button,
		]
	)
